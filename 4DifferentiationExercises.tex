...
\begin{center}
\includegraphics[width=14cm]{L4SZ2834}
\end{center}
...
\includegraphics[ width=13cm]{L4SZ2836}\\
...
\includegraphics[width=12cm]{L4SZ2837}%Use Desmos to check
...
\clearpage	\Question You may have to combine rules to differentiate the following
\begin{tasks}(2)
