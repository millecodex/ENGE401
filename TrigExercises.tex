...
\begin{Exercise}[title={Applications},label=exApplications]
	...
	\begin{tasks}(2)
		\task 	\includegraphics[width=4cm]{L4SZ2823}%$318.8$ 
		\task 	\includegraphics[width=4cm]{L4SZ2824}%	\ang{44}
	\end{tasks}
...
\Question Use either the Sine Rule or Cosine Rule as appropriate to find $x$ and $\theta$.
	\begin{tasks}(2)
		\task 	\includegraphics[width=4cm]{L4SZ282G}%2
		\task 	\includegraphics[width=4cm]{L4SZ282H}%\ang{84.6}
	\end{tasks}
