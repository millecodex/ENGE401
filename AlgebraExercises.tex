...
\end{tasks}
\Question Given $f(x)=x$ and $g(x)=\sin x$, graph $f$, $g$, and $f +g$ on a common screen to illustrate graphical addition. %{L4SZ2817}
...
\Question %Graph the three functions on a common screen using \desmos. How are the graphs related? 
\begin{tasks}
	\task 	\includegraphics[width=4cm]{L4SZ2818}\\
	\task   \includegraphics[width=4cm]{L4SZ2819}\\
\end{tasks}
\Question %Given $f(x)=x$ and $g(x)=\sin x$
\includegraphics[width=4cm]{L4SZ2817}
