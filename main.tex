...
\renewcommand{\AnswerHeader}{\ifthenelse{\boolean{firstanswerofthechapter}}%
	{\bigskip\noindent{\textbf{CHAPTER \thechapter}}\newline\newline%
		...
		\noindent\bfseries \tcbox[boxrule=0pt, colback=gray!20, colframe=gray!20,  size=fbox,  arc=0pt, outer arc=0pt]{\AnswerName\ \ExerciseHeaderNB, Page 			\pageref{\AnswerRef}}\smallskip}
	   {\noindent\bfseries\tcbox[boxrule=0pt, colback=gray!20, colframe=gray!20,  size=fbox,  arc=0pt, outer arc=0pt]{\AnswerName\ \ExerciseHeaderNB, Page     \pageref{\AnswerRef}}\smallskip}}
%
