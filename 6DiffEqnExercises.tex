...
\begin{Exercise}[title={Differential Equations},label=exDiffEqns]
	...
	\begin{tasks}(2)
	\task $\frac{\mathrm{d}y}{\mathrm{d}t} =e^{t} +2 t\text{\quad \quad }y (0) =2$ %$\;y =e^{t} +t^{2} +1$ 
	\task $\dydx =\sin  2 x +\cos  2 x\text{\quad \quad }y (0) =0$ %$\;y =\frac{1}{2} \left (\sin  2 x -\cos  2 x +1\right )$
	\task $t \frac{\mathrm{d}y}{\mathrm{d}t} =1 -t^{2}\text{\quad \quad }y \left (0\right ) =2$ % $\;y =\ln  \left \vert t\right \vert  -\frac{t^{2}}{2} +1$ 
	\task $x^{2} \frac{\mathrm{d} P}{\mathrm{d} x} =2 +x\text{\quad \quad }P (1) =2$ %$\;P = -\frac{2}{x} +\ln  \left \vert x\right \vert  +4$ 
	\end{tasks}
...
\begin{Exercise}[title={Separable Equations},label=exSepEqns]
	...
	\begin{tasks}
		\task  $y \dydx =x\text{\quad \quad }$given $y =4$ when $x =0$ %$y^{2} =x^{2} +16$
		\task $\frac{1}{t} \frac{\mathrm{d} v}{\mathrm{d} t} =2\text{\quad \quad }$given $v =2$ when $t =1$ %$\;v =t^{2} +1$ 
		\task $e^{x} \dydx +2 =0\text{\quad \quad }$given $y =5$ when $x =0$ %$y =2 e^{ -x} +3$
		\task $\left (x +2\right ) \dydx =y +3\text{\quad \quad }$given $y =0$ when $x =0$ %$y =\frac{3}{2} x$
		\task $\frac{\mathrm{d} i}{\mathrm{d} t} +i =1\text{\quad \quad }$given $i =10$ when $t =0$ %$i =-(9e)^{ -t} +1$
		\task $\dydx -2 x =0\text{\quad \quad }y (0) =2$ %$y =x^2+2$ 
	\end{tasks}
