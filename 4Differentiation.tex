...
\begin{figure}[h]\begin{center}
		...
		\addplot [<->,domain=-4.9:4.75,thick, samples=400, black] {x*sin(deg(x+x^2))};
		\addplot[mark=*] coordinates {(-1.915,-1.884)};
%		\addplot [dashed,domain=0:2.5,thick, samples=200, black] {-2};
		\addplot[dashed,domain=-2.5:-1.25,ultra thick,samples=50, black]{-1.884};
...
The average rate of change of the function $\displaystyle y =f (x)$ is $\displaystyle\frac{\text{change in }y}{\text{change in }x}$ or $\displaystyle\frac{f (b) -f (a)}{b -a}$.
...
%
% more examples of chain rule here...
%
%
