...
\begin{tasks}(2)
	\task \includegraphics[width=2.3047in, height=2.6472in,]{L4SZ2829}
	%	$f (x) =3^{x}$ 
	%\includegraphics[width=2.3047in, height=2.6472in,]{L4SZ282R}
	
	\task \includegraphics[width=2.7164in, height=2.5676in,]{L4SZ2829}
	%$f (x) =5^{x}$ 
	%\includegraphics[ width=2.7164in, height=2.5676in,]{L4SZ282S}
	
	\task \includegraphics[width=2.207in, height=2.6394in,]{L4SZ2829}
	%$f (x) =\genfrac{(}{)}{}{}{1}{4}^{x}$ 
	%\includegraphics[ width=2.207in, height=2.6394in,]{L4SZ282T}
	
	\task \includegraphics[width=2.3938in, height=2.6385in,]{L4SZ2829}
	%$f (x) =\genfrac{(}{)}{}{}{1}{2}^{x}$ 
...
\begin{tasks}(2)
	\task The given graph is $y =3^x$. Draw $y = -3^{x}$. % Use Desmos to verify.
	\includegraphics[width=4cm]{L4SZ2829}
	%\includegraphics[]{L4SZ282V}
	
	\task The given graph is $y =2^x$. Draw $y =2^{x} -3$.% Use Desmos to verify.
	\includegraphics[width=4cm]{L4SZ2829}
	%\includegraphics[]{L4SZ282W}
	
	\task The given graph is $y =\frac{1}{2}^{x}$. Draw $y =4 +\frac{1}{2}^{x}$.% Use Desmos to verify.
	\includegraphics[width=4cm]{L4SZ2829}
	%\includegraphics[]{L4SZ282X}
	
	\task The given graph is $y =10^{x}$. Draw $y =10^{x +3}$.% Use Desmos to verify.
	\includegraphics[width=4cm]{L4SZ2829}
	%\includegraphics[]{L4SZ282Y}
	
	\task The given graph is $y =e^{x}$. Draw $y = -e^{x}$. % Use Desmos to verify.
	\includegraphics[width=4cm]{L4SZ2829}
	%\includegraphics[]{L4SZ282Z}
	\task The given graph is $y =e^{ -x}$. Draw $y =e^{ -x} -1$.% Use Desmos to verify.
 \includegraphics[width=4cm]{L4SZ2829}
 %\includegraphics[]{L4SZ2830}
\end{tasks}
\end{Exercise}
%---------------------------------------------
